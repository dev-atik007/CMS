...
<body>
    ...
    <div class="page-wrapper">
        ...
        <main class="main">
        	<div class="page-header text-center" style="background-image: url('assets/website/images/page-header-bg.jpg')">
        		<div class="container">
            ...
            <nav aria-label="breadcrumb" class="breadcrumb-nav">
                <div class="container">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('web.maaster') }}">Home</a></li>
								...
								<td class="product-col">
									<div class="product">
										<figure class="product-media">
											<a href="#">
												<img src="assets/website/images/products/table/product-1.jpg" alt="Product image">
											</a>
										</figure>
							...
							<tr>
								<td class="product-col">
									<div class="product">
										<figure class="product-media">
											<a href="#">
												<img src="assets/website/images/products/table/product-2.jpg" alt="Product image">
											</a>
										</figure>
							...
							<tr>
								<td class="product-col">
									<div class="product">
										<figure class="product-media">
											<a href="#">
												<img src="assets/website/images/products/table/product-3.jpg" alt="Product image">
											</a>
										</figure>
